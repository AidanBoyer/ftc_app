...
public class legacyDriveTest1 extends OpMode
{
    ...
    public void loop()
    {
        ...
        LeftRearDriveValue = scaledJoyDrive(gamepad1.left_stick_y * -1);
        RightRearDriveValue = scaledJoyDrive(gamepad1.right_stick_y * -1);
        LeftFrontDriveValue = scaledJoyDrive(gamepad1.left_stick_y * -1);
        RightFrontDriveValue = scaledJoyDrive(gamepad1.right_stick_y * -1);
