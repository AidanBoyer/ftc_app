...
public class blockUsingCypherTest extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(vuMark == RelicRecoveryVuMark.CENTER) {cypherSpecificDriveDistance = 0.80;}
        if(vuMark == RelicRecoveryVuMark.LEFT) {cypherSpecificDriveDistance = 0.18;}
        if(vuMark == RelicRecoveryVuMark.RIGHT) {cypherSpecificDriveDistance = 1.42;}
