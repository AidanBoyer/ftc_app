...
/**
 * Created by agb on 1/2/2018.
 */

@Autonomous(name = "knock off jewel")

public class pushJewel extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        waitForStart(); //_________________________________________
        ...
        if(redAlliance)
        {
            ...
            {
                turnUsingGyro(10, 0.25, 0.09, 0.3); // turn right
            }
            else
            {
                turnUsingGyro(-10, 0.25, 0.09, 0.3); // turn left
            }
        }
