...
public class MasqAdafruitIMU {
    ...
    public double[] getAngularOrientation() {
        Orientation angOrientation = imu.getAngularOrientation();

        double x = angOrientation.firstAngle;
        double y = angOrientation.secondAngle;
        double z = angOrientation.thirdAngle;
    ...
    public String telemetrize() {
        double[] angles = getAngularOrientation();
