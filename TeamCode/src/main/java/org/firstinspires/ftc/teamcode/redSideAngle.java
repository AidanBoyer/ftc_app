...
@Autonomous(name = "red, side, angle")

public class redSideAngle extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(vuMark == RelicRecoveryVuMark.CENTER) {cypherSpecificDriveDistance = -1;}
        if(vuMark == RelicRecoveryVuMark.LEFT) {cypherSpecificDriveDistance = -1.67;}
        if(vuMark == RelicRecoveryVuMark.RIGHT) {cypherSpecificDriveDistance = -1.95;}
